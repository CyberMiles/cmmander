...
<div class="container">
    <section>
        <form @submit.prevent="sendTx">
            ...
            <b-field horizontal label="Proposal Id">
                <b-input v-model="proposalId" placeholder=""></b-input>
            </b-field>

            <b-field horizontal label="Answer">
                <b-input v-model="answer" placeholder=""></b-input>
            </b-field>
